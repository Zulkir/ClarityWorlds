...
namespace Clarity.App.Transport.Prototype
{
    public class Playback : IPlayback
    {
        ...
        public Playback(IRenderLoopDispatcher renderLoopDispatcher, IStateVisualizer stateVisualizer, ISimFrameGenerator frameGenerator)
        {
        ...
        public void OpenFile(string filePath)
        {
            ...
            else
            {
                ...
                using (var logReader = new LogReader(stream))
