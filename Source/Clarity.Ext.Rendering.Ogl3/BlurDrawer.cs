...
void main()
{
    ...
    out_color = texture(DiffuseMap, vec2((gl_FragCoord.x + OffsetX) / Width, (gl_FragCoord.y + OffsetY) / Height), 3);
}
";
            #endregion
        ...
        public void Draw(ITexture2D resolvedTexture, ViewportInt viewport)
        {
            ...
            paramsUb.SetData(new IntVector4(viewport.X, viewport.Y, resolvedTexture.Width, resolvedTexture.Height));
