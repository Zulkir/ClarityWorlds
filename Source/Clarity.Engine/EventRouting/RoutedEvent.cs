...
{
    public class RoutedEvent<TArgs> : IRoutedEvent<TArgs>
    {
        ...
        private readonly List<RoutedEventSubscription<TArgs>> subscriptions;

        public IReadOnlyList<IRoutedEventSubscription<TArgs>> Subscriptions => subscriptions;

        public RoutedEvent(string name)
        {
            Name = name;
            subscriptions = new List<RoutedEventSubscription<TArgs>>();
        }
        ...
        public void Subscribe(string subscriptionName, Action<IEventRoutingContext, TArgs> handlerAction,
            IReadOnlyList<Type> affectedServiceTypes)
        {
            subscriptions.Add(new RoutedEventSubscription<TArgs>(subscriptionName, handlerAction, affectedServiceTypes));
        }
