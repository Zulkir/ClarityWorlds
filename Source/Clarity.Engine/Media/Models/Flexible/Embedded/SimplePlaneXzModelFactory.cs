...
namespace Clarity.Engine.Media.Models.Flexible.Embedded
{
    public class SimplePlaneXzModelFactory : ResourceFactoryBase
    {
        ...
        public override IResource GetNew(IResourceSource resourceSource)
        {
            ...
            var vertices = new[]
            {
                new CgVertexPosNormTex(-1f, 0f, 1f, 0f, 0f, 1f, 0f, 1f),
                new CgVertexPosNormTex(-1f, 0f, -1f, 0f, 0f, 1f, 0f, 0f),
                new CgVertexPosNormTex(1f, 0f, -1f, 0f, 0f, 1f, 1f, 0f),
                new CgVertexPosNormTex(1f, 0f, 1f, 0f, 0f, 1f, 1f, 1f),
            };
            var indices = new int[]
            {
                0, 1, 2, 0, 2, 3
